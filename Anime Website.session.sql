...
CREATE TABLE Episode(
    id INTEGER PRIMARY KEY AUTO_INCREMENT,
    anime_url VARCHAR(50) NOT NULL,
    video_url TEXT NOT NULL,
    tracks JSON NOT NULL,
    episode_number INTEGER NOT NULL,
    FOREIGN KEY (anime_url) REFERENCES Anime(folder_name)
);

-- @block
INSERT INTO Anime(name, folder_name, nicknames, season, description, studios, genre, episodes, duration, premiered, other_seasons_folders, other_seasons_names, poster)
...
'["CoMix Wave Films"]', '["Drama","Fantasy","Romance"]', 1, 114, '2019-07-19', '[]', '[]', 'https://cdn.myanimelist.net/images/anime/1009/103147l.jpg');

-- @block
INSERT INTO Episode(anime_url, video_url, tracks, episode_number)
VALUES('Tenki_No_Ko', 'https://eno.tendoloads.com/_.m3u8', '["https://cc.bunnyccdn.co/ca/6e/ca6e95a207b37aa7dfff60a5fe12dd75/eng-3.vtt"]', 1)
