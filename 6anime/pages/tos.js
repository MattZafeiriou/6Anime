...
export default function Disclaimer({ data }) {
    ...
    return (
        <>
            <Head>
                <title>6Anime - Terms Of Service </title>
                <meta property="og:title" content="6Anime - Disclaimer" />
                <meta
            ...
            <div className="tos">
                ...
                <p>We are 6Anime LLC ("<b>Company</b>", "<b>we</b>", "<b>our</b>"), a company registered in Netherlands.</p>
                <br />
                <p>We operate the website <a href='https://www.6anime.tv'>https://www.6anime.tv</a> (the "<b>Site</b>"), as well as any other related products and services that refer or link to these legal terms (the "<b>Legal Terms</b>")(collectively, the "<b>Services</b>").</p>
                <p>You can contact us by email at contact@6anime.tv</p>
                <br />
                <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and 6Anime LLC, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
                <br />
                <p>We will provide you with prior notice of any scheduled changes to the Services you are using. Changes to Legal Terms will become effective seven (7) days after the notice is given, except if the changes apply to security updates, bug fixes, and new functionality, in which case the changes will be effective immediately. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms. If you disagree with such changes, you may terminate Services as per the section "TERM AND TERMINATION."</p>
                <br />
                ...
                <p>9. SOCIAL MEDIA</p>
                <p>10. THIRD-PARTY WEBSITES AND CONTENT</p>
                <p>11. ADVERTISERS</p>
                <p>12. SERVICES MANAGEMENT</p>
                <p>13. PRIVACY POLICY</p>
                <p>14. COPYRIGHT INFRINGEMENTS</p>
                ...
                <br />
                <p>We are the owner or the licensee of all intellectual property rights in our Services, including all source code, databases, functionality, software, website designs, audio, video, text, photographs, and graphics in the Services (collectively, the "<b>Content</b>"), as well as the trademarks, service marks, and logos contained therein (the "<b>Marks</b>").</p>
                ...
                <p>Subject to your compliance with these Legal Terms, including the "<b>PROHIBITED ACTIVITIES</b>" section below, we grant you a non-exclusive, non-transferable, revocable license to:</p>
                <ul>
                    <li>
                ...
                <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:contact@6anime.tv">contact@6anime.tv</a></p>
                <p>We reserve all rights not expressly granted to you in and to the Services, Content, and Marks.</p>
                <p>Any breach of these Intellectual Property Rights will constitute a material breach of our Legal Terms and your right to use our Services will terminate immediately.</p>
                <p><b>Your submissions and contributions</b></p>
                <p>Please review this section and the "<b>PROHIBITED ACTIVITIES</b>" section carefully prior to using our Services to understand the (a) rights you give us and (b) obligations you have when you post or upload any content through the Services.</p>
                ...
                <p><b>Contributions:</b> The Services may invite you to chat, contribute to, or participate in blogs, message boards, online forums, and other functionality during which you may create, submit, post, display, transmit, publish, distribute, or broadcast content and materials to us or through the Services, including but not limited to text, writings, video, audio, photographs, music, graphics, comments, reviews, rating suggestions, personal information, or other material ("<b>Contributions</b>"). Any Submission that is publicly posted shall also be treated as a Contribution.</p>
                ...
                <br />
                <p>We respect the intellectual property rights of others. If you believe that any material available on or through the Services infringes upon any copyright you own or control, please immediately refer to the "<b>COPYRIGHT INFRINGEMENTS</b>" section below.</p>
                <br />
                ...
                <br />
                <p>These Legal Terms are governed by and interpreted following the laws of the Netherlands, and the use of the United Nations Convention of Contracts for the International Sales of Goods is expressly excluded. If your habitual residence is in the EU, and you are a consumer, you additionally possess the protection provided to you by obligatory provisions of the law in your country to residence. 6Anime LLC and yourself both agree to submit to the non-exclusive jurisdiction of the courts of NA, which means that you may make a claim to defend your consumer protection rights in regards to these Legal Terms in the Netherlands, or in the EU country in which you reside.</p>
                <br />
                <h4>18. DISPUTE RESOLUTION</h4>
                <br />
                <p>Informal Negotiations</p>
                <p>To expedite resolution and control the cost of any dispute, controversy, or claim related to these Legal Terms (each a "Dispute" and collectively, the "Disputes"), you and 6Anime LLC agree to first attempt to negotiate any Dispute (except those Disputes expressly provided below) informally for at least thirty (30) days before initiating arbitration. Such informal negotiations commence upon written notice from one person to the other.</p>
                ...
                <p>If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or prosecuted in the state and federal courts located in California, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction, and forum non conveniens with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Legal Terms.</p>
                ...
                <br />
                <h4>25. CALIFORNIA USERS AND RESIDENTS</h4>
                <br />
                ...
                <p>Netherlands</p>
                <p>
                    <a href="mailto:contact@6anime.tv">contact@6anime.tv</a>
                </p>
            </div>
        </>
    );
